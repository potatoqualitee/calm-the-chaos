...
The following categories are defined in [keywords/keyword-groups.json](keywords/keyword-groups.json), letting you choose when and how to engage with challenging topics:
