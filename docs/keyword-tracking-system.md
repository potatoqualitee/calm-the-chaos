...
### Keyword Processing
- Keywords are normalized for consistent matching
- Original keyword forms are preserved for display
- Supports both simple string and object formats with counts
...
- Calculates and displays total occurrences across all keywords
