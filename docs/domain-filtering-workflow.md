...
4. **Subdomain Handling:**
   ...
   - Implemented in urlMatcher.js using proper domain matching
...
- `popup/popupEvents.js`: Handles popup UI interactions and domain toggling
- `options/optionsStorage.js`: Manages storage operations and domain group toggling
- `scripts/core/config/preconfiguredDomains.js`: Defines pre-configured domains
- `scripts/background/urlMatcher.js`: Handles domain matching and filtering decisions
- `scripts/core/urlModule.js`: Core domain filtering logic and state management
